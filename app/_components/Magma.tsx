...
const Magma = () => {
  ...
  useEffect(() => {
    const handleScroll = (event: WheelEvent) => {
      ...
      const magma = magmaRef.current;

      if (scrollContainer && magma) {
        const rect = magma.getBoundingClientRect();
        const isMagmaInView =
  ...
  return (
    <div ref={magmaRef} className="relative w-full h-screen z-20">
      <div
        className="absolute inset-0 z-10"
        style={{
          backgroundImage: `url('/magma.jpg')`,
